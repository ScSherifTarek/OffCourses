...
?>          
  ...
  <section>
    <div class="container profile">
        ...
        <form id="form" action="" name="instructorUpdateForm" onsubmit="return validateInstructorUpdateForm()" method="post" autocomplete="off" enctype="multipart/form-data">
          <div id="err">
            <?php
          ...
          <div class="form-group">
              <div class="form-group">
                  ...
                  <input name="profile_image_url" type="file" class="form-control-file" id="fileInput">
                </div>

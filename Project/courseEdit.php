...
if (isset($_POST['save'])) {
    ...
    $result = Courses::update($course_id, $academy_id, $_POST['email'], $_POST['name'], $_POST['description'], $_POST['start_date'], $_POST['finish_date'], $_POST['price'], $image);
}
  ...
  <section>
    <div class="container profile">
      ...
      <form id="form" action="" method="post" autocomplete="off" enctype="multipart/form-data" >
          ...
          <div class="form-group">
              <input name="email" value="<?= ($instructor_email != null) ? $instructor_email : '' ?>" class="form-control" list="Emails" type="text" placeholder="Instructor email" >
              <datalist id="Emails">
                <?php 
